...
import { TOOL_LAYOUT } from '@/layouts'
...
const withPath = recursiveNormalizeRoutesPath(formatModulesList, '/tool')

const sorted = recursiveSortRoutesByOrder(withPath)

const testRouterList = recursiveHandleIframeRoutes(sorted)

console.log('%c Line:47 🍌 testRouterList', 'color:#4fff4B', testRouterList)
 ...
 *  获取快速菜单列表
 */
const testFastMenuList: RouterType.AdminRoute[] = recursiveFindRoutesByProperty(
  testRouterList,
  'meta.fastMenuOrder',
  undefined,
  {
