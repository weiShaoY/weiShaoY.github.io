  ...
  >
    ...
    >
      ...
      >
        ...
        <a-switch
          v-model="codeStore.state.navbar.visible"
          size="small"
        />
      </div>
      ...
      >
        ...
        <a-switch
          v-model="codeStore.state.tabBar.visible"
          size="small"
        />
      </div>
      ...
      >
        ...
        <a-switch
          v-model="codeStore.state.breadcrumb.visible"
          size="small"
        />
      </div>
      ...
      >
        ...
        <a-switch
          v-model="codeStore.state.footer.visible"
          size="small"
        />
      </div>
      ...
      >
        ...
        <a-select
          v-model="codeStore.state.menu.position"
          class="w-20"
        >
          <a-option
            value="left"
      ...
      >
        ...
        <a-input-number
          v-model="codeStore.state.menu.expandedWidth"
          size="small"
          class="w-20"
        />
      </div>
