...
export const TOOL_CONFIG = {
  /** 菜单类型 */
  menuType: ToolType.MenuTypeEnum.LEFT,
  ...
  /** 容器宽度 */
  containerWidth: ToolType.ContainerWidthEnum.FULL,
  ...
  system: {
    ...
    menuLayoutList: [
      {
        name: 'Left',
        value: ToolType.MenuTypeEnum.LEFT,
        img: verticalLayout,
      },
      {
        name: 'Top',
        value: ToolType.MenuTypeEnum.TOP,
        img: horizontalLayout,
      },
      {
        name: 'Mixed',
        value: ToolType.MenuTypeEnum.TOP_LEFT,
        img: mixedLayout,
      },
      {
        name: 'Dual Column',
        value: ToolType.MenuTypeEnum.DUAL_MENU,
        img: dualColumnLayout,
      },
    ],
