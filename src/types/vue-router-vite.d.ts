...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    '/admin/identityQuery/detail/': RouteRecordInfo<'/admin/identityQuery/detail/', '/admin/identityQuery/detail', Record<never, never>, Record<never, never>>,
    '/admin/identityQuery/result/': RouteRecordInfo<'/admin/identityQuery/result/', '/admin/identityQuery/result', Record<never, never>, Record<never, never>>,
  ...
  export interface _RouteFileInfoMap {
    'src/pages/admin/identityQuery/detail/index.vue': {
      routes: '/admin/identityQuery/detail/'
      views: never
    }
    'src/pages/admin/identityQuery/result/index.vue': {
      routes: '/admin/identityQuery/result/'
      views: never
    }
    'src/pages/admin/identityQuery/search/index.vue': {
      routes: '/admin/identityQuery/search/'
      views: never
    }
