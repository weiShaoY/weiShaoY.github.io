 ...
 */
export function toCssVar(propertyPath: string) {
 ...
 * ```
 */
export function toCssVars(propertyPath: string) {
 ...
 */
export function getThemeTokenVariants(propertyPath: string) {
 ...
 */
export function removePx(value: string | number): number {
  // 如果已经是数字，直接返回
