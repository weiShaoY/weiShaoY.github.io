...
<template>
  <div class="m-x-auto h-full flex flex-col justify-between container">
    ...
    <div class="grid gap-5 px-5 lg:grid-cols-4 md:grid-cols-3">
      ...
      >
        ...
        >
          <SvgIcon
            ...
            :size="60"
          />
          <h1 class="text-3xl font-semibold">Resume</h1>
        </a>
      </div>
      ...
      <!-- Stuff I like -->
      <div class="group indexGridBackgroundColor col-span-3 rounded-3xl p-8 hover:cursor-pointer hover:drop-shadow-2xl hover:transition hover:duration-500">
