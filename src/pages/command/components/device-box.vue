...
function initChart() {
  const dom: any = document.getElementById('barChart')
...
<template>
  <BasicBox
    :title="getModuleName('fireAwarenessEquipment')"
  >
    <div
      class="equipment-top"
    >
      <div
        class="equipment-item mr-[5px]"
        :class="[equipmentActive === 0 ? 'active' : '']"
        @click="handleType(0)"
      >
      ...
      <div
        class="equipment-item mr-[5px]"
        :class="[equipmentActive === 1 ? 'active' : '']"
        @click="handleType(1)"
      >
    ...
    >
      ...
      <div
        class="value-item placeholder"
      >
        故障
        <div
          class="value text-[#E3B026]"
        >
          {{
    ...
    <div
      ...
      :class="[equipmentActive === 1 ? 'pt-[30px]' : '']"
    >
      <div
...
.equipment-top {
  ...
  .equipment-item {
    ...
    height: 100%;
    flex: 1;
    background: url('../images/business/equipment-tag-bg.png') no-repeat;
    background-size: 100% 100%;
    &.active {
      background: url('../images/business/equipment-tag-bg-active.png') no-repeat;
      background-size: 100% 100%;
    }
  }
}
  ...
  .value-item {
    ...
    &.placeholder {
      ...
      &::after {
        ...
        width: 2px;
        height: 20px;
        background: linear-gradient(180deg, rgba(114, 218, 245, 0) 0%, #72daf5 46%, rgba(114, 218, 245, 0) 100%);
        margin: 0 5px;
      }
      &::before {
        content: '';
...
.chart-container {
  ...
  .bar-chart-title {
    ...
    height: 28px;
    width: 206px;
    background: url('../images/business/equipment-chart-title-bg.png') no-repeat;
    background-size: 100% 100%;
