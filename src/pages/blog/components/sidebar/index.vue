...
import type { FolderStructure, MarkdownFile } from './types'
...
// 生成文件夹的唯一标识
function getFolderKey(folder: FolderStructure): string {
  return folder.name
}

// 文件选择事件
function onFileSelect(file: MarkdownFile) {
