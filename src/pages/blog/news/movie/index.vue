  ...
  <el-tabs class="h-full w-full">
    ...
    >
      <div class="h-[calc(100vh-200px)]">
        <el-table class="!w-full" :data="movies" height="100%">
          <el-table-column prop="id" label="ID" :width="100" />

          <el-table-column prop="img" label="海报" :width="120">
            <template #default="{ row }">
              <PreviewImg :width="50" :src="row.img" />
            </template>
          </el-table-column>

          <el-table-column prop="nm" label="电影名称" align="center" />

          <el-table-column prop="rt" label="上映日期" align="center" sortable />

          <el-table-column prop="wish" label="期待值" align="center" sortable />

          <el-table-column prop="sc" label="评分" align="center" sortable>
            <template #default="{ row }">
              <span class="text-red">
