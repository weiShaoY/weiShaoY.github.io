...
function handleRefresh(time: number = 300) {
  ...
  setTimeout(() => {
    ...
    adminStore.isRefresh = !adminStore.isRefresh
  }, time)
}
...
function openSearchDialog() {
  adminMittBus.emit('openSearchDialog')
}
...
<template>
  <div
    ...
    :style="{
      width: topWidth,
      height: `${adminStore.setting.header.height}px`,
    }"
  >
    <!-- 左侧 -->
    <div
