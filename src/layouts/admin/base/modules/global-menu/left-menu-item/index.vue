...
const emits = defineEmits<{
   ...
   */
  adminMenuJump: [menu: RouterType.AdminRoute, jumpToFirst: boolean]
}>()
 ...
 * 当前路由对应的第一级菜单项
 */
const currentRoute = computed<RouterType.AdminRoute | undefined>(() => {
...
<template>
  ...
  <div
    ...
    :style="{
      width: `${adminStore.setting.menu.leftMenuWidth}px`,
    }"
  >
    <!-- logo -->
    <div
    ...
    >
      ...
      >
        <li
          ...
          @click="emits('adminMenuJump', menu, true)"
        >
          <el-tooltip
            class="box-item"
            effect="dark"
